<script lang="ts">
    ...
    import { questionParagraph, question, answers, correctAnswer, correctState, incorrectState, questionOutTransitionDuration, skipState, questionInTransitionDuration, endQuizWarningTab } from "./quiz-main-stores.ts"
