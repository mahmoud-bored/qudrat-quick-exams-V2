<script lang="ts">
    import { globalQuestionsAmount } from "$lib/stores"
    import { questionStreak, questionCounter, timer, questionFontSize } from "./quiz-main-stores"
...
<div class="container">
    <div class="left-side-container">
        <div class="question-counter-container">
            <span>{$questionCounter}</span> / {$globalQuestionsAmount}
        </div>
